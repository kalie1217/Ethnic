...
function Framework_class () {
  ...
  this.showFrameworkToolbar = function (title, showFullToolbar) {
    ...
    wl('</table>')
    wl('<tr>')
    if (isHeadstart) { wl('  <td colspan="7"><table class="sel1" style="background: url(' + applicationPath + 'js/toolbar/images/dps/head_toolbar2.jpg)">') } else { wl('  <td colspan="7"><table class="sel1" style="background: url(' + applicationPath + 'js/toolbar/images/dps/head_toolbar.jpg)">') }
    wl('	  <tr>')
    wl('		<td class="c3">&nbsp;</td>')
